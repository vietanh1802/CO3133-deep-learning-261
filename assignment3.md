...
## Dataset Proposal and Approval Status
- **Submitted:** _(TBA)_
- **Approval status:** _(Approved / Approved with conditions / Rejected)_
- **Conditions, if any:** _(TBA)_

## Dataset Description and EDA
_(TBA)_

## Methodology
_(Encoders, alignment, fusion stage and operation, losses.)_

## Experimental Setup
_(TBA)_

## Results
_(Unimodal A, unimodal B, simple fusion, improved fusion.)_
...
## Links
- Source code: _(TBA)_
- Checkpoints / reproduction instructions: _(TBA)_
- Report / slides: _(TBA)_
- YouTube presentation: _(TBA)_
